package chunggyeong.bibliophile.global.security;

import chunggyeong.bibliophile.global.exception.ExpiredTokenException;
...
import chunggyeong.bibliophile.global.security.auth.AuthDetails;
...
public class JwtTokenProvider {
    ...
    private final String ISSUER = "chunggyeong";
    ...
    public String resolveRefreshToken(HttpServletRequest request) {
        return resolveCookie(request, "BIBLIOPHILE_TOKEN_REFRESH");
    }
    ...
    public void setHeaderAccessToken(HttpServletResponse response, String accessToken) {
        Cookie accessTokenCookie = new Cookie("BIBLIOPHILE_TOKEN", accessToken);
    ...
    public void setHeaderAccessTokenEmpty(HttpServletResponse response) {
        Cookie accessTokenCookie = new Cookie("BIBLIOPHILE_TOKEN", "");
    ...
    public void setHeaderRefreshToken(HttpServletResponse response, String refreshToken) {
        Cookie refreshTokenCookie = new Cookie("BIBLIOPHILE_TOKEN_REFRESH", refreshToken);
    ...
    public void setHeaderRefreshTokenEmpty(HttpServletResponse response) {
        Cookie refreshTokenCookie = new Cookie("BIBLIOPHILE_TOKEN_REFRESH", "");
